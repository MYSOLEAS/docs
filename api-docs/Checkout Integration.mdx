...
### <a id="verify-trans"></a>[Verify Pay](https://doc.soleaspay.com/api-reference/endpoint/verifyTransaction) 
...
### <a id="verify-pay-endpoint"></a>[Convert](https://doc.soleaspay.com/api-reference/endpoint/converter) 
