...
- The payout is still **accepted by SoleasPay**, but marked as `ENQUEUED`.
...
For more details visite  [payout api-reference](https://doc.soleaspay.com/api-reference/endpoint/disbursePayment). 
