---
title: 'SoleasPay Connect'
description: 'SoleasPay Link API allows decentralized financial management within partner applications, offering flexible integration with a partner wallet while preserving your business logic.'
---
